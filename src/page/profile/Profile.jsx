    ...
    <div className='flex flex-col w-full h-full items-start justify-between'>
      <div className='bg-white w-full p-6 rounded-md'>
        <div className='flex justify-start items-center gap-3'>
          <button className='py-3 px-6 bg-blue-600 hover:opacity-90 transition duration-300 rounded-md'>
        ...
        <Divider orientation='left' orientationMargin={0}>
          <span className='text-gray-800 font-bold text-md'>Shop Information</span>
        </Divider>
